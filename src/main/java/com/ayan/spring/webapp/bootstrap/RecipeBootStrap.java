...
import com.ayan.spring.webapp.domain.*;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public List<Recipe> getRecipeList() {
        ...
        // one to one : recipe - notes - bidirectional

        guacRecipe.setNotes(guacNotes);

        // one to many : recipe - ingredient unidirectional
        ...
        // One to many Recipe - Category - bidirectional
        ...
        // One to One Note - Recipe
        tacoNotes.setRecipe(tacosRecipe);
        tacosRecipe.setNotes(tacoNotes);

        // One to  Many - Ingredients - Recipe
