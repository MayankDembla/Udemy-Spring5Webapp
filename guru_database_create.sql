...
alter table recipe_category add constraint FK8rf34vwu37hr74kpvrdkpor55 foreign key (category_id) references recipe (id)
alter table recipe_category add constraint FKdfxv834neju0yq245t3w6odcf foreign key (recipe_id) references category (id)
